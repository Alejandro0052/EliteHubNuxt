<template>
  <div class="w-full min-h-screen bg-surface-container dark:bg-surface-container-dark">
    ...
    <div v-else-if="!canEdit" class="p-6 bg-yellow-50 rounded dark:text-gray-900">No tienes permiso para editar este evento.</div>
    ...
    <form v-else @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div class="flex items-center gap-4">
        ...
        <NuxtLink :to="`/eventos/${route.params.id}`" replace class="button-secondary px-6 py-2 font-semibold inline-block">Cancelar</NuxtLink>
      </div>
